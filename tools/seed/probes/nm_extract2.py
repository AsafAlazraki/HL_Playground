...
WANT |= {575,576,583,584,586,587,594,595,597,598,603,604,619,620}
WANT |= {846,847,854,863,864,871,812,813,820}
...
wb.close()
json.dump(out, open('nm_rows2.json','w',encoding='utf-8'), indent=1, default=str)
