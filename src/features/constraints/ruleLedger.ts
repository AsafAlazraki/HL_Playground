...
export const RULE_GROUPS: readonly RuleGroup[] = [
  {
    ...
    name: 'Trailers',
    kind: 'trailer',
    say: 'What goes under a hull, and its rating.',
  },
  {
    id: 'motors',
    name: 'Motors',
  ...
  },
  {
    ...
    kind: 'accessory',
    say: 'The kit, the propeller, the hours.',
  },
  {
    id: 'boat-row',
    name: 'The boat row',
    kind: 'boat',
    say: 'Settled before anything is bolted on.',
  },
  {
    id: 'registration',
    name: 'Registration',
    ...
    say: 'Collected for someone else, by band.',
  },
] as const
...
export interface RuleMeasure {
   ...
   *  words: "live pairings". Never jargon, never a column reference —
   *  the reference is the provenance line.
   *
   *  A NOUN PHRASE, NOT A CLAUSE. These were full predicates — "581 of
   *  581 testable live pairings TAKE A TRAILER FROM A SERIES BUILT FOR
   *  THE BOAT'S OWN BRAND" — set eighteen pixels above `statement`,
   *  which says the same thing in the same words. Sixteen cards each
   *  saying their rule twice is most of what made this surface measure
   *  69 % explanation. The denominator names what was counted; the
   *  rule is stated once, underneath. */
  of: string
}
...
export const RULE_LEDGER: readonly RuleLedgerEntry[] = [
  /* ---- trailers ---- */
  {
    ref: 'F8',
    group: 'trailers',
    measure: { held: 581, tested: 581, of: 'testable live pairings' },
    caveat:
  ...
  },
  {
    ref: 'F9',
    group: 'trailers',
    measure: { held: 530, tested: 530, of: 'live pairings' },
    caveat:
  ...
  /* ---- motors ---- */
  {
    ref: 'A1',
    group: 'motors',
    measure: { held: 1424, tested: 1424, of: 'live standard and first-alternative motors' },
    caveat:
  ...
  },
  {
    ref: 'A2',
    group: 'motors',
    measure: { held: 685, tested: 757, of: 'live standard-fit motors' },
    caveat:
  ...
  },
  {
    ref: 'F6',
    group: 'motors',
    measure: { held: 3902, tested: 3905, of: 'live loose-motor cells' },
    caveat:
  ...
  },
  {
    ref: 'F7',
    group: 'motors',
    measure: { held: 7830, tested: 7830, of: 'remote-helm cells' },
    caveat:
  ...
  /* ---- rigging and propellers ---- */
  {
    ref: 'F15',
    group: 'rigging',
    measure: { held: 555, tested: 571, of: 'testable live triples' },
    caveat:
  ...
  },
  {
    ref: 'F16',
    group: 'rigging',
    measure: { held: 1576, tested: 1576, of: 'mechanical-control pairings' },
    caveat:
  ...
  },
  {
    ref: 'A3',
    group: 'rigging',
    measure: { held: 3890, tested: 4017, of: 'live pairings' },
    caveat:
  ...
  },
  {
    ref: 'R9',
    group: 'rigging',
    measure: { held: 2436, tested: 2436, of: 'labour cells' },
    caveat:
  ...
  /* ---- the boat row ---- */
  {
    ref: 'A5',
    group: 'boat-row',
    measure: { held: 2005, tested: 2005, of: 'boat rows with five deposit stages' },
    caveat: 'Written as =100%-SUM(QD:QG) on 378 master cells, and not one row disagrees.',
  },
  {
    ref: 'F12',
    group: 'boat-row',
    measure: { held: 1196, tested: 1196, of: 'multi-battery pre-delivery cells' },
    caveat:
